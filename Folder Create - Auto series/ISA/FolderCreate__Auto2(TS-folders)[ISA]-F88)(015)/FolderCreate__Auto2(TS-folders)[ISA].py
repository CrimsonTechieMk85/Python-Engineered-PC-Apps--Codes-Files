...
class Ui_MainWindow(QWidget):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Folder Create: Auto-2 (Timestamp folders) [Improved.Simplified.Alternative]"))
        ...
        self.create_button.setStatusTip(_translate("MainWindow", "Click here create timestamps folders. (Press Enter)"))
        ...
        self.exit_button.setStatusTip(_translate("MainWindow", "Click here create timestamps folders. (Press Esc)"))
        ...
        try:
            ...
            if len(returned_path_lists) == 0 or returned_path_lists == ['']:
                ...
                for path in returned_path_lists:
                    ...
                    # Variable current months number-month sub folder
                    ...
                    # Variable current day number folder path
                    now_day_no_sub_folder_path = os.path.join(now_mnthsno_months, dt_dd)

                    path_lsts = [now_yrs_sub_folder_path,now_mnthsno_months,now_day_no_sub_folder_path]
