...
paths_json_name = f'paths_lists-{rand_str}'
...
class Ui_MainWindow(QWidget):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.create_button.setStatusTip(_translate("MainWindow", "Click create timestamps folders. (Press Enter)"))
        ...
        self.exit_button.setStatusTip(_translate("MainWindow", "Click exit timestamps folders. (Press Esc)"))
