...
et_audio_app_folder_name = '{} collections'.format(file_name)
...
pathjson_fl_name = '{}.json'.format(app_json_name)

appdatas_json_fl_path = os.path.join(wDir_path,pathjson_fl_name)
...
appjson_fl_name = '{}.json'.format(path_json_name)

pathdatas_json_fl_path = os.path.join(wDir_path,appjson_fl_name)
...
class app_ui(wx.Frame):
    ...
    def read_json(self,jsonfl_path2,k2):
        ...
        while True:
            ...
            try:
                ...
                if jsonfl_path2 == pathdatas_json_fl_path:
    ...
    def save_path_json(self):
        ...
        if os.path.exists(pathdatas_json_fl_path)==False:
            ...
            if dir_dlgbox.ShowModal() == wx.ID_OK:
                ...
                self.save_json(jsonfl_path1=appdatas_json_fl_path,k1=appdata_jsonfl_key,v1=client_lsts,msg_txt1="Path saved.",msg_title1="Path save - Complete")
    ...
    def save_names_json(self):
        ...
        if os.path.exists(appdatas_json_fl_path) == False:
            ...
            self.save_json(jsonfl_path1=appdatas_json_fl_path,k1=appdata_jsonfl_key,v1=client_lsts,msg_txt1="Names data saved.",msg_title1="Names save - Complete")
    ...
    def overwrite_path_json(self):
        ...
        if dir_dlgbox.ShowModal() == wx.ID_OK:
            ...
            usr_rt_v2 = dir_dlgbox.GetPath()
 
            self.save_json(jsonfl_path1=pathdatas_json_fl_path,k1=path_jsonfl_key,v1=usr_rt_v2,msg_txt1="Path data reseted.",msg_title1="Path reset - Complete")
    ...
    def overwrite_name_json(self):
        self.save_json(jsonfl_path1=appdatas_json_fl_path,k1=appdata_jsonfl_key,v1=client_lsts,msg_txt1="Name data reseted.",msg_title1="Name reset - Complete")

    def make_dirs(self,jsonfl_path5,k5):
        ...
        if os.path.exists(pathdatas_json_fl_path)==True:
            ...
            with open(jsonfl_path5, 'r') as jsonfl_r:

                data2 = jsonfl_r.read()

                infos_v5 = json.loads(data2)[k5]
    ...
    def changedir(self,event):
        ...
        if os.path.exists(pathdatas_json_fl_path)==True:
            ...
            if dir_dlgbox.ShowModal() == wx.ID_OK:
                ...
                self.update_json(json_flpath3=pathdatas_json_fl_path,key3=path_jsonfl_key,info3=usr_rt_v)

                self.make_dirs(jsonfl_path5=appdatas_json_fl_path,k5=appdata_jsonfl_key)             
                ...
                if self.name_del_input.ShowModal() == wx.ID_OK:
                    ...
                    if name_del_in != "":
                        if name_del_in in returned_names:
                            ...
                            self.save_json(jsonfl_path1=appdatas_json_fl_path,k1=appdata_jsonfl_key,v1=returned_names)

                            name_del_dirs = os.path.join(returned_path,name_del_in)
                ...
                if self.name_add_input.ShowModal() == wx.ID_OK:
                    ...
                    if name_in != "":
                        ...
                        if name_in not in returned_name_data:
                            ...
                            self.save_json(jsonfl_path1=appdatas_json_fl_path,k1=path_jsonfl_key,v1=returned_name_data)

                            self.make_dirs(self,jsonfl_path5=appdatas_json_fl_path,k5=appdata_jsonfl_key)
