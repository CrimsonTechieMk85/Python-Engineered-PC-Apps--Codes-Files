...
class app_ui(wx.Frame):
        ...
        while True:
            ...
            try:
                ...
                if jsonfl_path2 == pathdatas_json_fl_path:
                    returned_dir_dlgbox_ou2t= self.overwrite_path_json()

                    if returned_dir_dlgbox_out2.ShowModal() == wx.ID_OK:

                        usr_rt_v2 = returned_dir_dlgbox_out2.GetPath()
            
                        self.save_json(jsonfl_path1=pathdatas_json_fl_path,k1=path_jsonfl_key,v1=usr_rt_v2,msg_txt1="'{}' json file reseted.".format(pathjson_fl_name),msg_title1="Path Data Json file reset - Complete")
                    else:
                        break
                else:
    ...
    def delete_names(self,event):
        ...
        returned_path_data  = self.read_json(jsonfl_path2=pathdatas_json_fl_path,k2=path_jsonfl_key)
