...
class AppUi(wx.Frame):
    ...
    # type combobox
        ...
        self.type_lists = ['Google','Google images','YouTube videos','YouTube channels','Wikipedia','Amazon products','Flipkart products','Myntra products','Ajio products']
    ...
    def onlineSearchprivate(self,event):
            ...
            while True:
                ...
                if self.browser_path_in.ShowModal() == wx.ID_OK:
                    ...
                    if browser_path_in !="":
                        ...
                        if os.path.exists(browser_path_in)==True and 'Chrome' in browser_path_json_srcfl:
        ...
        if q == "":
            ...
            try:
                ...
                incognito_browser_open_cmd = r'"{}" --incognito %s'.format(browser_path_jsonsrc)

                incognito_browser_open = r'"{}" --incognito'.format(browser_path_jsonsrc)

                if os.path.exists(browser_path_jsonsrc)==True and "Chrome" in browser_path_jsonsrc :
