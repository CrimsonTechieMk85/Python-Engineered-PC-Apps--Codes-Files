...
main_app_title = "Opera C12 [Perfected.Further+]: Auto"
...
class AppUi(wx.Frame):
    ...
    def __init__(self, parent, id):
        ...
        self.type_lists = ['Google', 'Google images','Bing','Bing images', 'Yahoo','Yahoo images', 'YouTube videos', 'YouTube channels', 'Wikipedia',
                           'Amazon products', 'Flipkart products', 'Myntra products', 'Ajio products','Deviantarts','Danbaroo pics','Hyperpreg pics']
