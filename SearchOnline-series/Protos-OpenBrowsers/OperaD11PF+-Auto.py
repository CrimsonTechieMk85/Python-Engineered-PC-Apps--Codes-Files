...
main_app_title = "Opera D11 [Perfected.Further+]: Auto"
...
def open_incognito_opera(batch_file_path,url_req):
...
def open_opera(batch_file_path,url_req):
...
class AppUi(wx.Frame):
    ...
    def __init__(self, parent, id):
        ...
        self.type_lists = ['Google', 'Google images','Bing','Bing images', 'Yahoo','Yahoo images', 'YouTube videos', 'YouTube channels', 'Wikipedia',
                           'Amazon products', 'Flipkart products', 'Myntra products', 'Ajio products','Invidous videos','Invidous channels','Deviantarts collections','Danbaroo pics']

        self.typecomboBox = wx.ComboBox(self.wpanel, -1, 'Google', (156, 103), (321, 34), self.type_lists,
    ...
    def onlineSearchprivate(self, event):
        ...
        if q == "":
            ...
            invidous__v_srch_link = f"https://invidious.snopyta.org/search?q={q_re}"

            invidous__ch_srch_link = f"https://invidious.snopyta.org/channel/{q_re}"
            ...
            if "Google images" in str_type:
                ...
                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=g_img_srch_link)
                ...
                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=g_srch_link)
                ...
                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=bing_img_srch_link)
                ...
                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=bing_srh_link)
                ...
                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=yahoo_img_srch_link)
                ...
                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=yahoo_srch_link)
                ...
                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=yt_v_srch_link)
                ...
                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=amazon_link)
                ...
                # wb = webbrowser.get(browser_open_cmd)
                # wb.open(ajio_link)
                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=ajio_link)
                ...
                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=myntra_link)
                ...
                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=flipkart_link)
                ...
                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=yt_ch_srch_link)


            elif "Danbaroo" in str_type:

                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=danbaroo_srch_link)

            elif "Invidous channels" in str_type:

                open_opera(batch_file_path=bat_rt_fl, url_req=invidous__ch_srch_link)

            elif "Invidous videos" in str_type:

                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=invidous__v_srch_link)

            elif "Deviantarts" in str_type:

                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=devinatart_srch_link)

            elif "hyperpreg" in str_type:

                open_incognito_opera(batch_file_path=bat_rt_fl, url_req=hyperpreg_srch_link)
            else:
    ...
    def onlineSearch(self, event):
        ...
        if q == "":
            ...
            if "Google images" in str_type:
                ...
                open_opera(batch_file_path=bat_rt_fl, url_req=g_srch_link)
                ...
                open_opera(batch_file_path=bat_rt_fl, url_req=bing_img_srch_link)
                ...
                open_opera(batch_file_path=bat_rt_fl, url_req=bing_srh_link)
                ...
                open_opera(batch_file_path=bat_rt_fl, url_req=yahoo_img_srch_link)
                ...
                open_opera(batch_file_path=bat_rt_fl, url_req=yahoo_srch_link)
            elif "YouTube videos" in str_type:
                ...
                open_opera(batch_file_path=bat_rt_fl, url_req=yt_v_srch_link)
                ...
                open_opera(batch_file_path=bat_rt_fl, url_req=amazon_link)
                ...
                #wb = webbrowser.get(browser_open_cmd)
                #wb.open(ajio_link)
                open_opera(batch_file_path=bat_rt_fl, url_req=ajio_link)
                ...
                open_opera(batch_file_path=bat_rt_fl, url_req=myntra_link)
                ...
                open_opera(batch_file_path=bat_rt_fl, url_req=flipkart_link)
                ...
                open_opera(batch_file_path=bat_rt_fl, url_req=danbaroo_srch_link)
                ...
                open_opera(batch_file_path=bat_rt_fl, url_req=invidous__v_srch_link)


            elif "Deviantarts" in str_type:

                open_opera(batch_file_path=bat_rt_fl, url_req=devinatart_srch_link)

            elif "Hyperpreg" in str_type:

                open_opera(batch_file_path=bat_rt_fl, url_req=hyperpreg_srch_link)
                ...
                open_opera(batch_file_path=bat_rt_fl, url_req=yt_ch_srch_link)
            else:
