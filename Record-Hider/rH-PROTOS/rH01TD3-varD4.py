...
# Json files path
flsdirsdatas_flname_json = 'files_folders_datas'

dirsdatas_json_fl_name = '{}.json'.format(flsdirsdatas_flname_json)

flsdirs_datas_jsonflpath = os.path.join(wDir_path,dirsdatas_json_fl_name)
...
def make_run_rh_batfl(batflpath,rh_cmd):
                        ...
                        if n==1:
                            ...
                            if fl_name=="" or fl_extnts== "":
                                ...
                                if fl_exists == False:
                                    ...
                                    make_run_rh_batfl(batflpath=bat1_hidefile_flpath,rh_cmd=cmd1)                                  
                                    ...
                                    json_file_datas_w = open(flsdirs_datas_jsonflpath, "w")
                            ...
                            json_file_datas_r = open(flsdirs_datas_jsonflpath, 'r')
                            ...
                            make_run_rh_batfl(batflpath=bat2_unhidefile_flpath,rh_cmd=cmd2)
                        ...
                        if n==1:
                            ...
                            if dir_name=="":
                                ...
                                if dir_exists == False:
                                    ...
                                    make_run_rh_batfl(batflpath=bat1_hidedirs_flpath,rh_cmd=cmd1)
                                    ...
                                    json_dirs_datas_w = open(flsdirs_datas_jsonflpath, "w")
                            ...
                            json_dirs_datas_r = open(flsdirs_datas_jsonflpath, 'r')
                            ...
                            make_run_rh_batfl(batflpath=bat2_unhidedirs_flpath,rh_cmd=cmd2)
