                ...
                while True:
                    ...
                    if n=="":
                        ...
                        if n==1:
                            ...
                            bat1_flpath = os.path.join(wDir_path,"recodeHider-file_opt1.bat")
                            ...
                            cmd2 = "cmd /c 'Attrib -h -s -r {}'".format(fl_full_path)

                            bat2_flpath = os.path.join(wDir_path,"recodeHider-file_opt2.bat")
                ...
                while True:
                    ...
                    if n=="":
                        ...
                        if n==1:
                            ...
                            bat1_flpath = os.path.join(wDir_path,"recodeHider-folder_opt1.bat")
                            ...
                            bat2_flpath = os.path.join(wDir_path,"recodeHider-folder_opt2.bat")
