...
hidefl_bat_flname = "recodeHider-file_opt1"

hidefl_bat_fl = "{}.bat".format(hidefl_bat_flname)
#

hidedir_bat_flname = "recodeHider-folder_opt1"

hidedir_bat_fl = "{}.bat".format(hidedir_bat_flname)
#

unhidefl_bat_flname = "recodeHider-file_opt2"

unhidefl_bat_fl = "{}.bat".format(unhidefl_bat_flname)
#

unhidedir_bat_flname = "recodeHider-folder_opt2"
