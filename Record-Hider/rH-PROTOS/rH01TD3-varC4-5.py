...
def json_infos_dump(jsonfl_path,infos):
    json_datas_w = open(jsonfl_path, "w")
                        ...
                        if n==1:
                            ...
                            if fl_name=="" or fl_extnts== "":
                                ...
                                if fl_exists == False:
                                    ...
                                    file_names_v = json.loads(data2)["file_names"]

                                    file_names_v.append(fl_name)

                                    file_types_v = json.loads(data2)["file_types"]

                                    file_types_v.append(fl_extnts)

                                    file_paths_v = json.loads(data2)["file_paths"]

                                    file_paths_v.append(fl_path)

                                    datas_new_lists = {
                                        "file_names": file_names_v,
                                        "file_types": file_types_v,
                                        "file_paths": file_paths_v
                                    }

                                    json_infos_dump(jsonfl_path=appdatas_json_settings,infos=datas_new_lists)
                            ...
                            for name in json_flname:

                                for type in json_flextnts:
                                    file = "{0}.{1}".format(name,type)
