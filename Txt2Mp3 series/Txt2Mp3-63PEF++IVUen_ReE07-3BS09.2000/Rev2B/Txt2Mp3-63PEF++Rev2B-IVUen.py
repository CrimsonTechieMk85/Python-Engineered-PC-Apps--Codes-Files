...
# App title
app_title = "Txt-2-Mp3 6.3 (Perfected.Even.Further++ Revised-2B) [Individual.Variable.Utility-enhanced]"
...
main_folder_name = 'Txt-2-Mp3 6.3 (P.E.F++ Rev-2B) [I.V.U-en]'
...
class app_ui(wx.Frame):
    ...
    def appMp3s_foldershortcut_maker_dtrev2B(self,path1, path2, path3, path4, app_folder_name4):
    ...
    def change_dir(self, event):
        ...
        if dir_dlgbox.ShowModal() == wx.ID_OK:
            ...
            try:
                ...
                self.appMp3s_foldershortcut_maker_dtrev2B(path1=app_main_folder_path, path2=now_yrs_sub_folder_path,
    ...
    def open_mp3_folder_dt(self,event):
        ...
        if os.path.exists(settings_json_fl_rt) == True:
            ...
            self.appMp3s_foldershortcut_maker_dtrev2B(path1=app_main_folder_path,path2=now_yrs_sub_folder_path,path3=now_mnthsno_months,path4=now_date_sub_folder_path,app_folder_name4=audio_app_folder_name)
