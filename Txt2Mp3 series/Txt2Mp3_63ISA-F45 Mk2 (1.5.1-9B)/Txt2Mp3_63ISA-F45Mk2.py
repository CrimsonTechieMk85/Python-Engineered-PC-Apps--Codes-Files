...
import datetime
import json
from gtts import gTTS , gTTSError , lang# using google-text-to-speech (gtts) service
...
cfl_path = os.path.realpath(__file__)

# Get file name & extentions
cfl_name , cfl_extnts = os.path.splitext(os.path.basename(cfl_path))

# Get current directory\path
# cdir = os.path.dirname(cfl_path)
...
app_folder_name = 'Txt-2-Mp3 6.3 Mk2 [I.S.A]'
...
# App title
app_title = "Txt-2-Mp3 6.3 Mark 2 [Improved.Simplified.Alternative]"
...
# Accent lists
accent_lsts1 = ["en","fr","zh-CN","zh-TW","pt","es"]

# Accent lists - Dynamic from gTTS server
accent_lsts2 = lang.tts_langs().keys()
# print(accent_lsts2)

# TDL lists     
tdl_lsts2 = ["com.au","co.uk","com","ca","co.in","ie","co.za","ca","fr","com.br","pt","com.mx","es"]
...
class isaUI(QWidget):
    ...
    # Frame 1
        ...
        self.frame_1.setGeometry(QtCore.QRect(0, 0,800, 600))
    ...
    # Select Accent
        ...
        self.accent_comboBox.setGeometry(QtCore.QRect(65, 220, 155, 71))

        font = QtGui.QFont()
        font.setPointSize(26)
        self.accent_comboBox.setFont(font)
        self.accent_comboBox.setObjectName("accent_comboBox")
        # self.accent_comboBox.setEditable(True)
        ...
        # self.accent_comboBox.addItem("")
        # self.accent_comboBox.addItem("")
        self.accent_comboBox.addItems(accent_lsts2)
    ...
    # Select TDL
        ...
        # self.tdl_comboBox.addItem("")
        # self.tdl_comboBox.addItem("")
        self.tdl_comboBox.addItems(tdl_lsts2)
    ...
    # Frame 2 
        self.frame_2.setStatusTip(_translate("MainWindow",app_ver))
    ...
    # Accent combo box items
        self.accent_comboBox.setCurrentText(_translate("MainWindow", "en"))
        """
    ...
    def access_audios(self):
        ...
        if os.path.exists(paths_datas_json_file_path) == True:
            ...
            dir = os.listdir(returned_now_date_sub_folder_v)

            # Checking if the list is empty or not
            if len(dir) == 0:

                logerr_txt = f"Access Denied: No text converted audios found in directory '{returned_now_date_sub_folder_v}'."
                self.apps_log_sys(logerr_msg=logerr_txt,err_msgtitle="Access denied - No text converted audios found: ",err_msgtxt="No text converted audios found.             ")
            else:
    ...
    def playMp3(self):
        ...
        if os.path.exists(paths_datas_json_file_path) == True:
            ...
            if len(dir) == 0:
                ...
                logerr_txt = f"PlayMp3 Error: No text converted audios found in directory '{returned_now_date_sub_folder_v}'."
                self.apps_log_sys(logerr_msg=logerr_txt,err_msgtitle="PlayMp3 Error - No text converted audios found: ",err_msgtxt="Opps! PlayMp3 couldn't run since there are no text converted audios found.           ")
                ...
                file , check = QFileDialog.getOpenFileName(self, fl_dialog_title,returned_now_date_sub_folder_v, wild_cards)
                if check:
    ...
    def gtts_v(self,path_gtts_audio,txt,accent,tdl):
        ...
        try:
            ...
            self.msg_autoClose(msg_text=f"'{txt}' text sucessfully converted into '{audio_name_mp3}' audio file.",msg_title="Text to audio file (.Mp3) status - Complete",close_tmr=3,msg_icon=QMessageBox.Information)
            ...
            returned_msg_outs = self.yn_msgbox(txt5="Do you wish to convert another text into audio?",title5="Clear - Yes/No?",msg_icon=QMessageBox.Question)
