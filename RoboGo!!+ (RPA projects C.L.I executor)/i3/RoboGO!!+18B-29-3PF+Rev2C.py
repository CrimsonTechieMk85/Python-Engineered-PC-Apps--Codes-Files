...
et_app_title= "RoboGO!!+ [Early-Tests.Id: {}]".format(file_name)

# App title 
app_title = "RoboGO!!+ 18B-2.9-3 [Perfected.Further+ Revised-2C]"
                        ...
                        for file in files:
                            if file == returned_executor:
                                ...
                                uiPath_appinfos_dict = {
                                    "UiRobot_exePath": str(full_exe_path)
                                }
                    ...
                    if modify_filedir_dlgbox.ShowModal() == wx.ID_OK:
                        ...
                        if fileroot_v == "":
                            ...
                            if returned_executor in fileroot_v:
                                ...
                                try:
                                    uiPath_appinfos_dict= {
                                        "UiRobot_exePath": str(fileroot_v)
                                        }
                                    ...
                                    settings_json.write("{"'"UiRobot_exePath"'":")
    ...
    def start(self,event):
        ...
        if settings_json_paths_exists == False:
            ...
            if dir_dlgbox.ShowModal() == wx.ID_OK:
                ...
                save_json(json_flpath=app_datas_json_file_path,infos1=usr_rt_v,infos2=returned_executor)
