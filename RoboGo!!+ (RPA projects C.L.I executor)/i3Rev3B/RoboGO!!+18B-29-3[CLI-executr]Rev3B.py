...
dependies_folder_path=os.path.join(wDir_path,".dependies293-Rev3B")
...
bat_folder_name = "RoboGo!!+ 18B-2.9-3 [RPA projects C.L.I executer] Rev3B batch files"
...
init_batfl_name = "init293Rev3B_Executer.bat"
#init_bat_fl_path= os.path.join(wDir_path,"init_UipathRobot.bat")

# --------------------------------------------------------------------------------------------------
''' Settings details '''
# App settings json files
info_jsonfl_name = "ExecuterInfos_293Rev2B"

appinfos_json = "{}.json".format(info_jsonfl_name)

appinfos_srcfl_path=os.path.join(bot_infos_dirs,appinfos_json)
...
et_app_title= "RoboGO!!+ 18B-2.9-3 Rev3B [Early-Tests.Id: {}]".format(file_name)

# App title 
app_title = "RoboGO!!+ 18B-2.9-3 [RPA projects C.L.I executer] Revised-3B"
...
class app_ui(wx.Frame):
    ...
    def save_executer_infos_json(self,json_flpath,executorfl_fullpath,k6):
        infos6 = {
                                k6 : str(executorfl_fullpath)
                            }
    ...
    def save_json(self,json_flpath, infos1,infos2,k1,k2):
    ...
    def read_json(self,json_flpath,k1,k2):
        try:
            ...
            executer_infos_v = json.loads(data)[k2]

            read_json.close()

            return path_infos_v , executer_infos_v
    ...
    def save_appdatas(self):
        ...
        if os.path.exists(app_datas_json_file_path) == False:
            ...
            if dir_dlgbox.ShowModal() == wx.ID_OK:
                ...
                self.save_json(json_flpath=app_datas_json_file_path,infos1=usr_rt_v,infos2=botexecute_fl,k1="path",k2="bot_executer")
        ...
        if os.path.exists(appinfos_srcfl_path) == False:
            ...
            for root, dirs, files in os.walk("C:\\"):
                ...
                for file in files:
                    if file == botexecute_fl:
                        ...
                        self.save_executer_infos_json(json_flpath=appinfos_srcfl_path,executorfl_fullpath=full_exe_path,k6="Bot_executerpath")
                        ...
                        pass
                if os.path.exists(appinfos_srcfl_path) == True:
                    break
                else:
                    pass
        else:
    ...
    def open_batdirs(self,event):
        ...
        try:
            ...
            self.dirs_shortcut_maker3Rev3B(path1=init_bat_dir,path2=crnt_yrs_folder_path,path3=crnt_mnthsno_months,path4=now_date_folder_path)
    ...
    def modify(self,event):
        ...
        mode_modify_path_lists = ["Choose here to change the path of bot executer (UiRobot.exe app) automatically.",
                                  "Choose here to change the path of bot executer (UiRobot.exe app) manually.",
                                  "Choose here to change path of the '{}' folder.".format(bat_folder_name),
                                  "Choose here to change the bot executer (UiRobot.exe app) name automatically.",
                                  "Choose here to change the bot executer (UiRobot.exe app) path manually.",
                                  "Choose here to change the bot executer (UiRobot.exe app) name manually."]
        ...
        if onechoice_modes.ShowModal() == wx.ID_OK:
            ...
            if onechoice_modes.GetStringSelection() == mode_modify_path_lists[0]:
                ...
                while True:
                    manual_modify_UiRobot_execfl_dlgbox = wx.TextEntryDialog(frame, 'Enter the full path of the bot executer file (Eg: UiRobot.exe)', 'executer file modify settings:')
                    ...
                    if manual_modify_UiRobot_execfl_dlgbox.ShowModal() == wx.ID_OK:
                        ...
                        if os.path.exists(manual_botexec_v)== True:
                            ...
                            try:
                                ...
                                self.update_json_exe(json_flpath=app_datas_json_file_path, infos=str(manual_botexecfl_v),k5="bot_executer")
                                ...
                                self.dirs_shortcut_maker3Rev3B(path1=init_bat_dir, path2=crnt_yrs_folder_path,
                                ...
                                self.save_json(json_flpath=appinfos_srcfl_path, infos1=returned_path,infos2=str(manual_botexecfl_v),k1="path",k2="bot_executer")
                ...
                while True:
                    ...
                    if manual_modify_UiRobot_execfl_dlgbox.ShowModal() == wx.ID_OK:
                        ...
                        try:
                            ...
                            self.save_json(json_flpath=app_datas_json_file_path, infos1=returned_path,infos2=str(manual_botexecfl_v),k1="path",k2="bot_executer")
                ...
                while True:
                    ...
                    if modify_dir_dlgbox.ShowModal() == wx.ID_OK:
                        ...
                        if usr_rt_v == "":
                            ...
                            try:
                                self.update_json_path(json_flpath=app_datas_json_file_path,infos=str(usr_rt_v),k4="path")
                        ...
                        if fileroot_v == "":
                            ...
                            if returned_executer in fileroot_v:
                                ...
                                try:
                                    ...
                                    self.save_json(json_flpath=appinfos_srcfl_path,infos1=str(fileroot_v),infos2=botexecute_fl,k1="path",k2="Bot_executerpath")
                ...
                while True:
                    ...
                    if modify_UiRobot_execfl_dlgbox.ShowModal() == wx.ID_OK:
                        ...
                        try:
                            ...
                            self.update_json_exe(json_flpath=app_datas_json_file_path, infos=str(usr_botexecfl_v),k5="bot_executer")
                            ...
                            self.save_json(json_flpath=app_datas_json_file_path, infos1=returned_path, infos2=str(usr_botexecfl_v),k1="path",k2="Bot_executerpath")
    ...
    def batch_support_runner_maker_3Rev3B(self,bot_infos_jsonfl_r7, files_rt7,init_bat_fl_path7,k7):
    ...
    def dirs_shortcut_maker3Rev3B(self,path1,path2,path3,path4):
        try:
            os.makedirs(path1)
        except OSError:
            pass
    ...
    def start(self,event):
        ...
        try:
            ...
            self.dirs_shortcut_maker3Rev3B(path1=init_bat_dir, path2=crnt_yrs_folder_path, path3=crnt_mnthsno_months,
            ...
            while True:
                ...
                if uipath_filedir_dlgbox.ShowModal() == wx.ID_OK:
                    ...
                    if '.xaml'in file_choosen :
                        ...
                        self.batch_support_runner_maker_3Rev3B(bot_infos_jsonfl_r7=appinfos_srcfl_path,
