...
dependies_folder_path=os.path.join(wDir_path,".dependies293-Rev3CC")
...
path_json_flname = 'path_datas293Rev3CC'
...
exectrfl_json_flname = 'botexectrfl_datas293Rev3CC'
...
bat_folder_name = "RoboGo!!+ 18B-2.9-3 [RPA projects C.L.I executer] Rev3CC batch files"
...
init_batfl_name = "init293Rev3CC_Executer.bat"
#init_bat_fl_path= os.path.join(wDir_path,"init_UipathRobot.bat")

# --------------------------------------------------------------------------------------------------
''' Settings details '''
# App settings json files
executerinfos_jsonfl_name = "ExecuterInfos_293Rev2CC"
...
et_app_title= "RoboGO!!+ 18B-2.9-3 Rev3CC [Early-Tests.Id: {}]".format(file_name)

# App title 
app_title = "RoboGO!!+ 18B-2.9-3 [RPA projects C.L.I executer] Revised-3CC"
...
class app_ui(wx.Frame):
    ...
    def save_json(self,json_flpath1, v1,k1):

        infos1 = {
            k1: str(v1)
        }

        json_fl_w1 = open(json_flpath1, "w")

        json.dump(infos1, json_fl_w1)

        json_fl_w1.close()

    # Update path to the existing value in a json file
    def update_json(self,json_flpath5, infos,k5):
        json_fl_r = open(json_flpath5, "r")

        json_src_data = json.load(json_fl_r)

        json_src_data[k5] = infos

        json_fl_w = open(json_flpath5, "w")
    ...
    # Delete orginal and save changes using experimental protocol: 'File finder'
    def rewrite_json_botexecuter(self,jsonfl_path9,executefl9,k9):

        os.remove(jsonfl_path9)
        ...
        for root, dirs, files in os.walk("C:\\"):
            ...
            for file in files:
                if file == executefl9:
                    ...
                    self.save_json(json_flpath1=jsonfl_path9,v1=full_exe_path,k1=k9)
                    ...
                    pass
            if os.path.exists(jsonfl_path9) == True:
                break
            else:
                pass
        else:
            ...
            for root, dirs, files in os.walk("C:\\"):
                ...
                for file in files:
                    if file == botexecute_fl:
                        ...
                        self.save_json(json_flpath1=executerinfos_srcfl_path,v1=full_exe_path,k1="Bot_executerpath")
    ...
    def save_json_path(self):
        ...
        if os.path.exists(path_datas_json_file_path) == False:
            ...
            if dir_dlgbox.ShowModal() == wx.ID_OK:
                ...
                self.save_json(json_flpath1=path_datas_json_file_path,v1=usr_rt_v,k1="path")
    ...
    def open_batdirs(self,event):
        ...
        try:
            ...
            self.dirs_shortcut_maker3Rev3CC(path1=init_bat_dir,path2=crnt_yrs_folder_path,path3=crnt_mnthsno_months,path4=now_date_folder_path)
        ...
        if onechoice_modes.ShowModal() == wx.ID_OK:
            ...
            if onechoice_modes.GetStringSelection() == mode_modify_path_lists[0]:
                ...
                try:
                    ...
                    self.rewrite_json_botexecuter(jsonfl_path9=executerinfos_srcfl_path,k9="Bot_executerpath",executefl9=returned_executer)

                except FileNotFoundError:

                    self.save_json_botexecuter()
                ...
                while True:
                    ...
                    if manual_modify_UiRobot_execfl_dlgbox.ShowModal() == wx.ID_OK:
                        ...
                        if manual_botexec_v =="":
                            invalid_err = wx.MessageDialog(self.wpanel,"Input invalid.","Input verifier error - Invalid query",wx.ICON_ERROR| wx.STAY_ON_TOP)
                            ...
                            if os.path.exists(manual_botexec_v)== True:
                                ...
                                try:
                                    ...
                                    self.update_json(json_flpath5=executerinfos_srcfl_path, infos=str(manual_botexecfl_v),k5="Bot_executerpath")
                                    ...
                                    self.save_json(json_flpath1=executerinfos_srcfl_path,v1=manual_botexecfl_v,k1="bot_executer")
                                ...
                                file_missing_msgbox = wx.MessageDialog(self.wpanel, "Opps! Sorry coundn't save changes since requested application is not found in the system.","Settings update error - File not found.",
                ...
                while True:
                    ...
                    if manual_modify_UiRobot_execfl_dlgbox.ShowModal() == wx.ID_OK:
                        ...
                        try:
                            ...
                            self.update_json(json_flpath5=bot_executr_fl_json_file_path, infos=str(manual_botexecfl_v),k5="bot_executer")
                            ...
                            self.save_json(json_flpath1=bot_executr_fl_json_file_path,v1=str(manual_botexecfl_v),k1="bot_executer")
                ...
                while True:
                    ...
                    if modify_dir_dlgbox.ShowModal() == wx.ID_OK:
                        ...
                        try:
                            self.update_json(json_flpath5=path_datas_json_file_path,infos=str(usr_rt_v),k5="path")
                    ...
                    try:
                        ...
                        if modify_filedir_dlgbox.ShowModal() == wx.ID_OK:
                            ...
                            if returned_executer in fileroot_v:
                                ...
                                #full_exe_path2 = os.path.join(root_v, returned_executer)

                                self.save_json(json_flpath1=executerinfos_srcfl_path,v1=fileroot_v,k1="Bot_executerpath")
                                ...
                                app_not_UiRobot_err = wx.MessageDialog(self.wpanel,"Opps! Sorry coundn't save changes since requested application '{}' is not  found in the system.".format(returned_executer),"Settings update error - File not found.",wx.ICON_ERROR| wx.STAY_ON_TOP)
                                                    
                                app_not_UiRobot_err.ShowModal()
                        else:
                            break
                    except FileNotFoundError:
                        self.save_json(json_flpath1=bot_executr_fl_json_file_path, v1=botexecute_fl,k1="bot_executer")
                ...
                while True:
                    ...
                    if modify_UiRobot_execfl_dlgbox.ShowModal() == wx.ID_OK:
                        ...
                        try:
                            ...
                            self.update_json(json_flpath5=bot_executr_fl_json_file_path, infos=str(usr_botexecfl_v),k5="bot_executer")
                            ...
                            self.save_json(json_flpath1=bot_executr_fl_json_file_path, v1=str(usr_botexecfl_v),k1="bot_executer")
    ...
    def batch_support_runner_maker_3Rev3CC(self,bot_infos_jsonfl_r7, files_rt7,init_bat_fl_path7,k7):
    ...
    def dirs_shortcut_maker3Rev3CC(self,path1,path2,path3,path4):
        try:
            os.makedirs(path1)
        except OSError:
            pass
    ...
    def start(self,event):
        ...
        try:
            ...
            self.dirs_shortcut_maker3Rev3CC(path1=init_bat_dir, path2=crnt_yrs_folder_path, path3=crnt_mnthsno_months,
            ...
            while True:
                ...
                if uipath_filedir_dlgbox.ShowModal() == wx.ID_OK:
                    ...
                    if '.xaml'in file_choosen :
                        ...
                        self.batch_support_runner_maker_3Rev3CC(bot_infos_jsonfl_r7=executerinfos_srcfl_path,
