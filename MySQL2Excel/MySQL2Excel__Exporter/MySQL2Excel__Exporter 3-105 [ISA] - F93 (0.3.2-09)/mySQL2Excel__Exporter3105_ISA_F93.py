...
# App Version
app_version = "Finalized 93 (version 0.3.2-09)"
...
class Ui_MainWindow(QWidget):
    ...
    def save_mysql(self):
        ...
        if os.path.exists(json_fl2_rt)== False:
            ...
            host.setWindowTitle("Get user MySQL user")
            host.setLabelText("Please enter the name of your MySQL host:")
            ...
            host_v1 = host.textValue()

            if okPressed1 and host_v1 != '':

                db = QInputDialog(self)
            
                db.setWindowTitle("Get user MySQL user database")
                ...
                if okPressed2 and db_v2 != '':
                    ...
                    user_name.setWindowTitle("Get MySQL user name")
                    ...
                    if okPressed3 and usr_v3 != '':
                        ...
                        passwrd.setWindowTitle( "Get user MySQL user password")
                        ...
                        passwrd_v4 = passwrd.textValue() 

                        if okPressed4 and passwrd_v4 != '':

                            tbl = QInputDialog(self)
                
                            tbl.setWindowTitle("Get user MySQL Table name")
                            tbl.setLabelText("Please enter of your MySQL table:")
                    ...
                    if okPressed8_2==True and tbl8_cols_name2 != '':
                        ...
                        if ok==True and filter_conditions_item:
                            ...
                            if filter_conditions_item != "BETWEEN":
                                ...
                                tbl9_cols = QInputDialog(self)
                                tbl9_cols.setWindowTitle("Filter MySQL database - column name entry:")
                                tbl9_cols.setLabelText(f"Please enter the value to be use as filter from '{tbl8_cols_name2}' column.")
                                tbl9_cols.setTextEchoMode(QLineEdit.Normal)
                                tbl9_cols.setStyleSheet(
                                    """
                                    QLabel{
                                        font-size:20px;
                                        font-family:Arial;
                                ...
                                tbl9_cols.resize(400, 240)
                                okPressed9_2 = tbl9_cols.exec_()
                                tbl9_cols_v2 = tbl9_cols.textValue()
                                ...
                                if okPressed9_2==True and tbl9_cols_v2 != '':
                                    ...
                                    sql_q = "select * from {0} where {1}{2}'{3}';".format(returned_mysql_table,tbl8_cols_name2,filter_conditions_item,tbl9_cols_v2)
                                ...
                                tbl8_1 = QInputDialog(self)
                                tbl8_1.setWindowTitle("Filter MySQL database - first value entry:")
                                tbl8_1.setLabelText("Please type the first value:")
                                tbl8_1.setTextEchoMode(QLineEdit.Normal)
                                tbl8_1.setStyleSheet(
                                    """
                                    QLabel{
                                        font-size:20px;
                                        font-family:Arial;
                                ...
                                tbl8_1.resize(400, 240)
                                okPressed11_1A = tbl8_1.exec_()
                                tbl8_val1A = tbl8_1.textValue()

                                if okPressed11_1A==True and tbl8_val1A != '':
                                    
                                    tbl8_2 = QInputDialog(self)
                                    tbl8_2.setWindowTitle("Filter MySQL database - second value entry:")
                                    tbl8_2.setLabelText("Please type the second value or cancel to only use the first value:")
                                    tbl8_2.setTextEchoMode(QLineEdit.Normal)
                                    tbl8_2.setStyleSheet(
                                        """
                                        QLabel{
                                            font-size:20px;
                                            font-family:Arial;
                                    ...
                                    tbl8_2.resize(400, 240)
                                    okPressed12_2A = tbl8_2.exec_()
                                    tbl8_val2A = tbl8_2.textValue()
                                ...
                                tbl8_cond1_val = tbl8_cond1.textValue()


                                if tbl8_cond1_okPressed==True and tbl8_cond1_val != '':
                                    ...
                                    tbl8_cond2_okPressed2 = tbl8_cond2.exec_()
                                    tbl8_cond2_val2 = tbl8_cond2.textValue()
                                    if tbl8_cond2_okPressed2 and tbl8_cond2 != '':
                                        self.msg_autoClose(msg_text=f"Started to export the table '{returned_mysql_table}' as excel file.                      ",msg_title="My2Excel Export - Started:",close_tmr=2,msg_icon=QMessageBox.Information)

                                        sql_q = "select * from {0} WHERE {1} BETWEEN {2} AND {3};".format(returned_mysql_table,tbl8_cols_name2,tbl8_cond1_val,tbl8_cond2_val2)
                                    ...
                                    elif tbl8_cond2_okPressed2 and tbl8_cond2_val2 == '':
                                        self.msg_autoClose(msg_text="Invalid input.                        ",msg_title="Input Verifer - Error:",close_tmr=3,msg_icon=QMessageBox.Critical)
                                    else:
                                        pass
                                elif tbl8_cond1_okPressed==True and tbl8_cond2_val2 == '':
                                    self.msg_autoClose(msg_text="Invalid input.                        ",msg_title="Input Verifer - Error:",close_tmr=3,msg_icon=QMessageBox.Critical)
                                else:
                                    pass
                        else:
