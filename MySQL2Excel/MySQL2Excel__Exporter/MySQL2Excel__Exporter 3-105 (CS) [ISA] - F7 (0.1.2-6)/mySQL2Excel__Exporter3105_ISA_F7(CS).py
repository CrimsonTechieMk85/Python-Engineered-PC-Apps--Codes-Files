...
class Ui_MainWindow(QWidget):
    ...
    # Button
        ...
        # Export filter button
        self.exprt_filter_btn5.setToolTip(_translate("MainWindow", "Click here to export selected records as excel file. (Ctrl+)"))
    ...
    def chngapp3_mysql_host(self):
        ...
        while True:
            ...
            # host2_v1, okPressed1_2 = QInputDialog.getText(self, "Get MySQL Host","Enter the name of your MySQL host:", QLineEdit.Normal, "localhost")
    ...
    def chngapp3_mysql_dbname(self):
        ...
        while True:
            ...
            # db2_v2, okPressed2_2 = QInputDialog.getText(self, "Modify app's MySQL database:","Enter the name of your MySQL database:", QLineEdit.Normal, "")
