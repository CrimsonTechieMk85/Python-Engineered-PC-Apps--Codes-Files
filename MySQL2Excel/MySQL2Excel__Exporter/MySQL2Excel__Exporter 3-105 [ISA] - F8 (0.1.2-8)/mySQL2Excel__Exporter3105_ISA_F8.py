...
fa_json_name = '{}_datas'.format(file_name)

fa_paths_infos_flname_json= '{}.json'.format(fa_json_name)

fa_path_datas_json_fl_rt = os.path.join(cdir,fa_paths_infos_flname_json)

''' 1st attempt - App Details '''
# 1st [First] attempt - App title ISA
fa_app_title = "I.S.A 1st attempt: mySQ2EXCEL Exporter [X0-{}]".format(file_name)

# 1st [First] attempt - audio folder with app name
fa_main_folder_name = '{} excel files'.format(file_name)
...
class Ui_MainWindow(QWidget):
    ...
    def foldershortcut_maker_dt(self,path1,path2,path3,path4):
        ...
        # fa_path = os.path.join(desktop, '{} - Shortcut.lnk'.format(fa_main_folder_name))
