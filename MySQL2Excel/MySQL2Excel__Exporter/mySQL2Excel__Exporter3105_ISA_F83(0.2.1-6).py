    ...
    def save_mysql(self):
        ...
        if os.path.exists(json_fl2_rt)== False:
            ...
            if okPressed1 and host_v1 != '':
                db_v2, okPressed2 = QInputDialog.getText(self, "Get user MySQL user","Please enter your MySQL database:", QLineEdit.Normal, "")
                
                if okPressed2 and db_v2 != '':

                    usr_v3, okPressed3 = QInputDialog.getText(self, "Get user MySQL user","Please enter your MySQL user name:", QLineEdit.Normal, "root")

                    if okPressed3 and usr_v3 != '':

                        passwrd_v4, okPressed4 = QInputDialog.getText(self, "Get user MySQL user","Please enter your MySQL password:", QLineEdit.Password, "")

                        if okPressed4 and passwrd_v4 != '':

                            tbl_v5, okPressed5 = QInputDialog.getText(self, "Get user MySQL user","Please enter of your MySQL table:", QLineEdit.Normal, "")
            ...
            while True:
                ...
                try:
                    ...
                    if os.path.exists(json_fl2_rt)== True:
                        ...
                        self.msg_autoClose(msg_text=f"Started to export the table '{returned_mysql_table}' as excel file.                      ",msg_title="My2Excel Export - Started:",close_tmr=3)
                        ...
                        # Excel file details
                        xlsxfl2_name = "{0}_{1}_MySQL-Xcel".format(returned_mysql_table,returned_mysql_db)
                        ...
                        if os.path.exists(xlsxfl2_path)==False:# Read json
                            ...
                            self.msg_autoClose(msg_text=f"MySQL table '{returned_mysql_table}' sucessfully exported as excel file ({xlsxfl2}).                      ",msg_title="My2Excel Export - Success:",close_tmr=6)
                            ...
                            del_msg_execValue = del_yn_msg.exec()

                            if del_msg_execValue == QMessageBox.No:
                                break
                            elif del_msg_execValue == QMessageBox.Yes:
                                os.remove(xlsxfl2_path)

                                self.msg_autoClose(msg_text=f"'{xlsxfl2}' sucessfully deleted.                      ",msg_title="Delete - Success:",close_tmr=3)
                            else:
                                pass
            ...
            while True:
                ...
                # try:
                    ...
                    if os.path.exists(json_fl2_rt)== True:
                        ...
                        cols_name_lsts = [i[0] for i in cursor2.description]
                        ...
                        if okPressed8_2==True and tbl8_cols_name2 != '':
                            ...
                            if ok==True and filter_conditions_item:
                                ...
                                if filter_conditions_item != "BETWEEN":
                                    ...
                                    tbl9_cols_v2, okPressed9_2 = QInputDialog.getText(self, "Filter MySQL database - value entry:",f"Please enter the value to be use as filter from '{tbl8_cols_name2}' column.", QLineEdit.Normal, "")
                            
                                    if okPressed9_2==True and tbl9_cols_v2 != '':

                                        # Requesting query to get filtered table from mySQL DB
                                        sql_q1 = "select * from {0} where {1}{2}'{3}';".format(returned_mysql_table,tbl8_cols_name2,filter_conditions_item,tbl9_cols_v2)
                                        ...
                                        # Fetches\Extracts data based on the query (sql_q)
                                        mysql_tbl_data_filtered = cursor2.fetchall()
                                        ...
                                        # Excel file details
                                        xlsxfl2_name = "{0}_{1}_MySQL-FilteredXcel".format(returned_mysql_table,returned_mysql_db)
                                    ...
                                    tbl8_val1A, okPressed11_1A = QInputDialog.getText(self, "Filter MySQL database - first value entry:","Please type the first value:", QLineEdit.Normal, "")

                                    if okPressed11_1A==True and tbl8_val1A != '':
                                        tbl8_val2A, okPressed12_2A = QInputDialog.getText(self, "Filter MySQL database- second value entry:","Please type the second value or cancel to only use the first value:", QLineEdit.Normal, "")
                                        
                                        if okPressed12_2A==True and tbl8_val2A != '':
                                            sql_q = "select * from {0} WHERE {1} IN ({2} , {3});".format(returned_mysql_table,tbl8_cols_name2,tbl8_val1A,tbl8_val2A)
                                        
                                            # Execute mySQL query
                                            cursor2.execute(sql_q)
                                            ...
                                            sql_q = "select * from {0} WHERE {1} IN ({2});".format(returned_mysql_table,tbl8_cols_name2,tbl8_val1A)
                                    ...
                                    tbl8_cond1, okPressed11_2 = QInputDialog.getText(self, "Filter MySQL database - first value entry:","Please type the first value:", QLineEdit.Normal, "")

                                    if okPressed11_2 and tbl8_cond1 != '':
                                        tbl8_cond2, okPressed12_2 =QInputDialog.getText(self, "Filter MySQL database - second value entry:","Please type the second value:", QLineEdit.Normal, "")
                                        
                                        if okPressed12_2 and tbl8_cond2 != '':
                                            sql_q = "select * from {0} WHERE {1} BETWEEN {2} AND {3};".format(returned_mysql_table,tbl8_cols_name2,tbl8_cond1,tbl8_cond2)
