...
# App title
app_title = "MySQL 2 Excel: Exporter 1-105 [Improved.Simplified.Alternative]"
...
class Ui_MainWindow(QWidget):
    ...
    def chngapp3_mysql_tblname(self):
        ...
        while True:
            ...
            tbl2_v5.setLabelText("Please enter new MySQL table to be changed:")
    ...
    def chngpath(self):
        ...
        if chngdir_dlgbox:
            ...
            try:
                ...
                self.json_write_infos(json_flpath1=path_json_fl1_rt,infos=usr_rt_v)
