...
app_folder_name = 'MySQL2Excel Exporter 1-105 [I.S.A]'
...
class Ui_MainWindow(QWidget):
    ...
    def apps_log_sys(self,logdirs6_path,log_dirname6,logfl_path6,infos6):
    ...
    # Buttons 
        ...
        # -> Access button
        self.access_btn_2.setToolTip(_translate("MainWindow", "Click here to  open '{}' sub folder.".format(dt_date)))
        ...
        if path_json_fl1_exists == True:
            ...
            try:
                ...
                if os.path.exists(json_fl2_rt)== True:
                    ...
                    sql_q1 = "SHOW columns FROM {}".format(returned_mysql_table)
                    ...
                    while True:
                        ...
                        if os.path.exists(xlsxfl2_path)==False:# Read json
                            ...
                            del_yn_msg.setWindowTitle("Exit - Yes/No:")
                ...
                self.apps_log_sys(logfl_path6=logfl_path,logdirs6_path=logs_folder_path,log_dirname6=log_dirname,infos6=log_err)
        else:
            pass
    ...
    def chngapp3_mysql_host(self):
        ...
        while True:
            ...
            # host2_v1, okPressed1_2 = QInputDialog.getText(self, "Get MySQL Host","Please enter new MySQL host:", QLineEdit.Normal, "localhost")

            if okPressed1_2==True and host2_v1_txt != '':

                if os.path.exists(json_fl2_rt)==True:
                    self.json_mysql_update_infos(json_flpath2=json_fl2_rt,info=host2_v1_txt,keys2=k1,msg_title2="MySQL host update - Complete:",msg_txt2="MySQL host succesfully changed.")
        ...
        while True:
            ...
            if okPressed3_2==True and usr2_v3_txt != '':
                ...
                if os.path.exists(json_fl2_rt)==True:
                    ...
                    self.json_mysql_update_infos(json_flpath2=json_fl2_rt,info=usr2_v3_txt,keys2=k3,msg_title2="MySQL user update - Complete:",msg_txt2="MySQL host succesfully changed.")
        ...
        while True:
            ...
            if okPressed4_2==True and passwrd2_v4_txt != '':
                ...
                if os.path.exists(json_fl2_rt)==True:
                    ...
                    self.json_mysql_update_infos(json_flpath2=json_fl2_rt,info=passwrd2_v4_txt,keys2=k4,msg_title2="MySQL user update - Complete:",msg_txt2="MySQL user succesfully changed.")
    ...
    def chngapp3_mysql_tblname(self):
        ...
        while True:
            ...
            tbl2_v5.setLabelText("Please enter new MySQL table name to be changed:")
            ...
            tbl2_v5_txt = tbl2_v5.textValue()
                # tbl2_v5, okPressed5_2 = QInputDialog.getText(self, "Modify app's MySQL table:","Please enter new MySQL table:", QLineEdit.Normal, "")
        ...
        while True:
            ...
            if okPressed2_2==True and db2_v2_txt != '':
                if os.path.exists(json_fl2_rt)==True:
                    ...
                    self.json_mysql_update_infos(json_flpath2=json_fl2_rt,info=db2_v2_txt,keys2=k2,msg_title2="MySQL data base update - Complete:",msg_txt2="MySQL data base succesfully changed.")
    ...
    def chngpath(self):
        ...
        if chngdir_dlgbox:
            ...
            try:
                ...
                self.json_write_infos(json_flpath=path_json_fl1_rt,infos=usr_rt_v)
