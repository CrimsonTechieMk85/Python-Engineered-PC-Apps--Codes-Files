...
button_fl = Button(bottomFrame,text="Click to convert",fg="white",bg="green",command=V_2_A)
button_fl.grid(row=18,column=3,padx=0, pady=0,ipadx=56,ipady=0) 
...
button_clr = Button(bottomFrame, text="Click to clear",fg="white",bg="blue", command=clr_btn)
button_clr.grid(row=30,column=3,padx=0, pady=0,ipadx=66,ipady=0) 

lbl_btn_clr = Label(bottomFrame, text = " ")
lbl_btn_clr.grid(row=33,column=3,sticky=E)

button_exit = Button(bottomFrame,text="Click to say good bye to Eve",fg="white",bg="red",command=exit_btn,anchor=S)
button_exit.grid(row=55,column=3,padx=0, pady=0,ipadx=30,ipady=0) 

lbl_btn_clr = Label(bottomFrame, text = " ")
lbl_btn_clr.grid(row=65,column=3,sticky=E)

button_Intro = Button(bottomFrame,text="Click to speak with Eve",fg="white",bg="purple",command=AI_eve,anchor=S)
button_Intro.grid(row=77,column=3,padx=0, pady=0,ipadx=44,ipady=0) 
root.mainloop()
