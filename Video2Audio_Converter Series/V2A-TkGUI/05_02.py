...
def AI_eve():
    ...
    Intro_3 = ("You are using Video-2-Audio The Converter version 4.5.2.2 ","This is Video-2-Audio The Converter version 4.5.2.2 ","This is version 4.5.2.2 of Video-2-Audio The Converter ","You are using version 4.5.2.2 of Video-2-Audio The Converter ")
...
#
        ...
        speak("DO you wish to convert next video into audio?")
        if answer == "yes":
            fl_name.delete(0, END)
            fl_path.delete(0, END)
...
label_name = Label(Midframe,text ="Name of the video file: ",bg="red",fg="white",font = ("Times New Roman", 10))
label_name.grid(row=4,column=0,sticky=N)
...
l_extnts = Label(bottomFrame, text = "Select the extension :",bg="black",fg="white",
...
label_path = Label(bottomFrame,text ="Path of the video file: ",bg="blue",fg="white",font = ("Times New Roman", 10))
...
lbl_btn_nts = Label(bottomFrame, text = " ")
lbl_btn_nts.grid(row=300,column=3,sticky=E)

status_00 = Label(bottomFrame,text='<<<<  Note : Software can only convert "MP4" (mp4) video file into audio.  >>>>',fg="yellow",bg="red",font = ("Times New Roman", 10),anchor=S)
status_00.grid(row=420,column=3,padx=0, pady=0,ipadx=20,ipady=0) 
