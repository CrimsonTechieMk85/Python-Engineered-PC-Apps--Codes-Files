...
status_00 = Label(bottomFrame,text='Note: Software can only convert "MP4" video file into audio.',fg="Yellow",bg="red",font = ("Times New Roman", 10),anchor=S)
status_00.grid(row=420,column=3,padx=0, pady=0,ipadx=22,ipady=0) 
