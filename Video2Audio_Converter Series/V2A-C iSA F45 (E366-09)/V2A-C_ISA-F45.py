...
class Ui_MainWindow(QWidget):
    ...
    def change_path(self):
        while True:
            try:
                ...
                # self.msg_autoClose(msg_title="Notify - Json file recorrection intiated",msg_text="Started to overwite the json file.",close_tmr=2,msg_icon=QMessageBox.Information)     
                ...
                # self.msg_autoClose(msg_title="Notify - Json file recorection intiated",msg_text="Started to overwite the json file.",close_tmr=2,msg_icon=QMessageBox.Information)
    ...
    def overwrite_path_json(self):
        ...
        dir_dialog_title = f"Please choose folder (or directory) to be reset path data:" 
        dir_dlgbox = QFileDialog.getExistingDirectory(self, caption=dir_dialog_title)
    ...
    def vid2aud(self):
        ...
        # self.convert_btn.clicked.disconnect(self.vid2aud)
            ...
            try:
                ...
                if dir_dlgbox:
                    ...
                    if file_count != 0:
                        ...
                        self.apps_log_sys(logerr_msg=f"Directory or folder '{get_choosen_dir}' has no video files to convert.",err_msgtxt="No videos found in found in the choosen directory",err_msgtitle="Empty Directory:")
                        pass
    ...
    def play_aud(self):
        ...
        # self.playmp3_btn_4.clicked.disconnect(self.play_aud)
    ...
    def rst(self):
        ...
        # print("\n-> Values reseted")
        # self.reset_btn_2.clicked.disconnect(self.rst)
