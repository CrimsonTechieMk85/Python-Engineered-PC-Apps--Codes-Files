...
filter_json_flkey = "vid_formats33"
...
class Ui_MainWindow(QWidget):
    ...
    def mutiple_file(self,path2):
        ...
        self.dir_dlgbox = QFileDialog.getExistingDirectory(self, caption=dir_dialog_title)
                
        if self.dir_dlgbox:
            # Get location of a directory\folder
            get_choosen_dir = self.dir_dlgbox.replace("/","\\")
    ...
    def play_aud(self):
        ...
        if returned_path_data != None: 
            ...
            if file_count !=0:
                ...
                self.apps_log_sys(logerr_msg=logerr_txt,err_msgtitle="PlayMp3 Error - No audios found: ",err_msgtxt="Opps! PlayMp3 couldn't run since there are no video converted audios found.           ")
        else:
            pass
