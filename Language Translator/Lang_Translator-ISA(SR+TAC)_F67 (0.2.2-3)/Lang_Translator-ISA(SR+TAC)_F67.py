...
class Ui_MainWindow(QWidget):
        ...
        if os.path.exists(paths_datas_json_file_path) == True:
            ...
            if txt=="":
                ...
                try:
                    ...
                    self.gtxt_to_aud(audio_path3=audio_full_path,lang3=returned_lang_key5,text3=translated1_txt)
    ...
    def sr_sys(self,dest_lang2):
        try:
            ...
            try:
                ...
                self.gtxt_to_aud(audio_path3=audio_full_path_sr,lang3=translated2_sr_lang,text3=str_sr_var)
    ...
    def gtxt_to_aud(self,audio_path3,text3,lang3):
        
        gtts_audios_dl = gTTS(text=text3,lang=lang3,slow=False,lang_check=True)

        gtts_audios_dl.save(audio_path3)

        mp3_flname , mp3_flextnts = os.path.splitext(audio_path3)

        self.msg_autoClose(msg_text=f"'{text3}' text sucessfully converted into '{mp3_flname}' audio file.",msg_title="Text to audio file (.Mp3) status - Complete",close_tmr=3,msg_icon=QMessageBox.Information)
    ...
    def open_output_logfl(self):
        ...
        if os.path.exists(paths_datas_json_file_path) == True:
            ...
            if len(dir) == 0:
                ...
                output_file_full_path = os.path.join(returned_now_date_sub_folder_v1,output_file)
