...
app_name = "PS 22 PEF++ (210F6.3 Rev2BB)"
...
''' Main App detials '''
# App details
app_title = "Portfolio Secure 22 Perfected.Even.Further ++ (210-F6.3 Rev2BB)"

# GUI messages heading app title
# sub_app_title = 'Portfolio Secure 22 Perfected.Even.Further ++ (210-F3.6)'

# database folder
app_db_folder_name = 'PS-22PEF++210F63 Rev2BB'
...
main_app_folder_name = 'Portfolio Secure 22 P.E.F ++ (210F6.3 Rev2BB)'
    ...
    def open_collection_folder_dt3(self, event):
        ...
        if json_path_datas_exists == True:
            ...
            open_onechoice = wx.SingleChoiceDialog(self.wpanel, "Which folder do you wish to access?",
                                                   '{} - open folder:'.format(app_title), fg_open_lists)
...
class FolderGuardian(wx.Dialog):
    ...
    def __init__(self, parent, id):
        ...
        self.name1_lbl = wx.StaticText(self.wpanel, -1, "Portfolio Secure 22 P.E.F ++ \n(210-F6.3 Rev2BB) - 'Folder Guardian'",
                                       (67, 85), (24, 24),
