...
# database folder
app_db_folder_name = 'PS-22[I.S.A]-1'
...
class Ui_MainWindow(QWidget):
    def setupUi(self, MainWindow):
        ...
        # self.actionOpen_Logs.setCheckable(True)
        ...
        self.menuOptions.addAction(self.actionOpen_Logs)
        
        self.menuOptions.addSeparator()
        
        self.menuOptions.addAction(self.actionOpen_collection_folder)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionOpen_Logs.setShortcut(_translate("MainWindow", "Ctrl+L"))
        ...
        self.actionOpen_Logs.triggered.connect(self.open_logsfolder)
        self.actionOpen_collection_folder.triggered.connect(self.open_collection_folder_dt3)
        ...
        self.Button_Open.clicked.connect(self.open_collection_folder_dt3)
        self.Button_Open_2.clicked.connect(self.open_collection_folder_dt3)
        ...
        if returned_lstsbox_gui_out == wx.ID_OK:
            ...
            if choosen_choice_var == modify_pswrds_lists[0]:
                ...
                while True:
                    ...
                    passwrd2_v4 = QInputDialog(self)
                    passwrd2_v4.setWindowTitle("'Folder Guardian' encrypted passcode entry:")
                    passwrd2_v4.setLabelText("Please type the 'Folder Guardian' encryption password.")
                    ...
                    elif okPressed4_2==True and folder_guardian_enc_passwrd2_v4_txt == '':
                        self.msg_autoClose(msg_text="Null values are not accepted.                            ",msg_title="Input verifier error:",close_tmr=3,msg_icon=QMessageBox.Critical)
                    else:
                        break
    ...
    def change_file_guardian_enc_passwrds(self):
        ...
        while True:
            ...
            if okPressed4_2==True and passwrd2_v4_txt != '':
                ...
                self.update_json(json_flpath3=passwords_json_file_path,info3=new_hashed_encrypt_passcode_file_guardian,keys3="hashed_encrypt_passcode_file_guardian",msg_title3="'File Guardian' Encryption Password update - Complete",msg_txt3="'File Guardian' encryption password changed.")
    ...
    def change_folder_guardian_enc_passwrds(self):
        ...
        while True:
            ...
            if okPressed4_2==True and passwrd2_v4_txt != '':
                ...
                self.update_json(json_flpath3=passwords_json_file_path,info3=new_hashed_encrypt_passcode_folder_guardian,keys3="hashed_encrypt_passcode_folder_guardian",msg_title3="'Folder Guardian' Encryption Password update - Complete",msg_txt3="'Folder Guardian' encryption password changed.")
            ...
            if choosen_choice_var == modify_pswrds_lists[0]:
                while True:
                    ...
                    if okPressed4_2==True and file_guardian_dec_passwrd2_v4_txt != '':
                        ...
                        if check_password_hash(returned_hashed_file_guard_decrypt_pass,file_guardian_dec_passwrd2_v4_txt)==True:
                            ...
                            self.msg_autoClose(msg_text="Wrong 'File Guardian' decryption password.            ",msg_title="Access denied - Incorrect decryption password:            ",close_tmr=2,msg_icon=QMessageBox.Critical)
                ...
                while True:
                    ...
                    if okPressed5_2==True and folder_guardian_dec_passwrd2_v4_txt != '':
                        ...
                        if check_password_hash(returned_hashed_folder_guard_decrypt_pass,folder_guardian_dec_passwrd2_v4_txt)==True:
                            self.msg_autoClose(msg_text="Password correct.                   ",msg_title="Access granted:                                  ",close_tmr=2,msg_icon=QMessageBox.Information)
                            ...
                            self.msg_autoClose(msg_text="Wrong 'Folder Guardian' decryption password.                       ",msg_title="Access denied - Incorrect decryption password:                     ",close_tmr=2,msg_icon=QMessageBox.Critical)
        ...
        while True:
            ...
            if okPressed4_2==True and passwrd2_v4_txt != '':
                ...
                if os.path.exists(passwords_json_file_path)==True:
                    ...
                    new_hashed_decrypt_passcode_file_guardian = generate_password_hash(passwrd2_v4_txt,method='sha256')

                    self.update_json(json_flpath3=passwords_json_file_path,info3=new_hashed_decrypt_passcode_file_guardian,keys3="hashed_decrypt_passcode_file_guardian",msg_title3="'File Guardian' Decryption Password update - Complete",msg_txt3="'File Guardian' decryption password changed.")
        ...
        while True:
            ...
            if okPressed4_2==True and passwrd2_v4_txt != '':
                ...
                if os.path.exists(passwords_json_file_path)==True:
                    ...
                    new_hashed_decrypt_passcode_folder_guardian = generate_password_hash(passwrd2_v4_txt,method='sha256')

                    self.update_json(json_flpath3=passwords_json_file_path,info3=new_hashed_decrypt_passcode_folder_guardian,keys3="hashed_decrypt_passcode_folder_guardian",msg_title3="'Folder Guardian' Decryption Password update - Complete",msg_txt3="'Folder Guardian' decryption password changed.")
    ...
    def open_collection_folder_dt3(self):
        # print("Folder openned")

        self.save_path_json()
 
        if os.path.exists(paths_datas_json_file_path) == True:

            open_lists = [f"Choose here to access '{collections_folder_name}' archives.",
                            f"Choose here to access '{encfiles_subfolder2_name}' archives.",
                            f"Choose here to access '{encfolders_subfolder2_name}' archives.",
                            f"Choose here to access '{decfiles_subfolder2_name}' archives.",
                            f"Choose here to access '{decfolders_subfolder2_name}' archives."]
            
            returned_lstsbox_gui_out , returned_lstsbox_item_out = self.lists_box(l2=open_lists,title2=f'{app_title} - open folders:',txt2="Which folder do you wish to access?")
        
                # choosen_choice_var = onechoice.GetStringSelection()
            # open_onechoice.ShowModal()
            
            # appUI(parent=None, id=-1).Show()
            if returned_lstsbox_gui_out == wx.ID_OK:
                choosen_choice_var = returned_lstsbox_item_out

                # print (f"\n Choosen mode -> {choosen_choice_var}")

                if choosen_choice_var == open_lists[0]:
                    self.open_ps_collections()
                elif choosen_choice_var == open_lists[1]:
                    self.open_ps_encfiles()
                elif choosen_choice_var == open_lists[2]:
                    self.open_ps_encfolders()
                    # pass
                elif choosen_choice_var == open_lists[3]:
    ...
    def open_ps_encfiles(self):
        try:
            returned_collections_folder_path , returned_encrypted_files_folder_path , returned_decrypted_files_folder_path, returned_crnt_yrs_folder_path_enc , returned_crnt_yrs_folder_path_dec , returned_now_mnthsno_mnths_sub_folder_enc , returned_now_mnthsno_mnths_sub_folder_dec , returned_now_date_folder_enc_path , returned_now_date_folder_dec_pat, returned_subfolder2_encfiles_path , returned_subfolder2_encfolders_path , returned_subfolder2_decfiles_path ,returned_subfolder2_decfolders_path =self.get_json_paths()
            # open collection folder
            os.startfile(returned_subfolder2_encfiles_path)
        except FileNotFoundError:
            pass
    ...
    def open_ps_encfolders(self):
        try:
            ...
            # open collection folder
            os.startfile(returned_subfolder2_encfolders_path)
        except FileNotFoundError:
            pass
    ...
    def open_ps_decfiles(self):
        try:
            returned_collections_folder_path , returned_encrypted_files_folder_path , returned_decrypted_files_folder_path, returned_crnt_yrs_folder_path_enc , returned_crnt_yrs_folder_path_dec , returned_now_mnthsno_mnths_sub_folder_enc , returned_now_mnthsno_mnths_sub_folder_dec , returned_now_date_folder_enc_path , returned_now_date_folder_dec_pat, returned_subfolder2_encfiles_path , returned_subfolder2_encfolders_path , returned_subfolder2_decfiles_path ,returned_subfolder2_decfolders_path =self.get_json_paths()
            # open collection folder
            os.startfile(returned_subfolder2_decfiles_path)
        except FileNotFoundError:
            pass
    ...
    def open_ps_decfolders(self):
        try:
            returned_collections_folder_path , returned_encrypted_files_folder_path , returned_decrypted_files_folder_path, returned_crnt_yrs_folder_path_enc , returned_crnt_yrs_folder_path_dec , returned_now_mnthsno_mnths_sub_folder_enc , returned_now_mnthsno_mnths_sub_folder_dec , returned_now_date_folder_enc_path , returned_now_date_folder_dec_pat, returned_subfolder2_encfiles_path , returned_subfolder2_encfolders_path , returned_subfolder2_decfiles_path ,returned_subfolder2_decfolders_path =self.get_json_paths()
            # open collection folder
            os.startfile(returned_subfolder2_decfolders_path)
        except FileNotFoundError:
            pass
