...
app_name = "PS 12 PEF++ (210 C3.6-type)"
...
''' Main App detials '''
# App details
app_title = "Portfolio secure 12 Perfected.Even.Further ++ (210-C3.6)"

# GUI messages heading app title
sub_app_title = 'PS 12 P.E.F++ 210 C3.6'

# database folder
app_db_folder_name = 'PS-12PEF++210C3.6'
...
main_app_folder_name = 'Portfolio secure 12 P.E.F ++ (210-C3.6)'
...
''' Sub apps '''
sub_psfiles_appname = 'PS-Files'
sub_psdirs_appname2 = 'PS-Dirs'
# Python
psfiles_pyfl = '{}.py'.format(sub_psfiles_appname)
psdirs_pyfl = '{}.py'.format(sub_psdirs_appname2)
sub_psfiles_pyfl_path = os.path.join(wDir_path,psfiles_pyfl)
sub_psdirs_pyfl_path = os.path.join(wDir_path,psdirs_pyfl)

# Exe
psfiles_exefl = '{}.exe'.format(sub_psfiles_appname)
psdirs_exefl = '{}.exe'.format(sub_psdirs_appname2)
sub_psfiles_exefl_path = os.path.join(wDir_path,psfiles_exefl)
sub_psdirs_exefl_path = os.path.join(wDir_path,psdirs_exefl)
...
class appUI(wx.Frame):
    ...
    def Closewindow(self, event):
        ...
        os.system('start /min cmd /c TASKKILL /F /IM {}'.format(psdirs_exefl))

        os.system('start /min cmd /c TASKKILL /F /IM {}'.format(psfiles_exefl))
    ...
    def dir_secure(self, event):
        ...
        # starts py file
        # os.startfile(sub_psdirs_exefl_path)
        os.startfile(psdirs_exefl)
    ...
    def modify2(self, event):
        ...
        fg_modify_lists = ["Change path for '{}' folder.".format(collections_folder_name), "Change password.",
                           "Change encrypted file name.","Change encrypted folder name."]
...
class FolderGuardian(wx.Frame):
    ...
    def __init__(self, parent, id):
        ...
        self.name1_lbl = wx.StaticText(self.wpanel, -1, "Portfolio secure 12 P.E.F ++ (210-C3.6) - \nFolder Guardian", (67, 85), (24, 24),
                ...
                try:
                    if os.path.exists(complete_file_rt_dec) == False:
                        ...
                        msg_dec_succcess = wx.MessageDialog(self.wpanel,
                                                            ...
                                                            "{} - decryption info.".format(sub_app_title),
...
if __name__ == '__main__':
    ...
    PS_window = appUI(parent=None, id=-1)
