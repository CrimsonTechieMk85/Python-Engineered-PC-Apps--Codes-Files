...
app_name = "PS 12 PEF++ (210F3.6.3-1Revised)"
...
''' Main App detials '''
# App details
app_title = "Portfolio secure 12 Perfected.Even.Further ++ (210F3.6.3-1 Revised)"

# GUI messages heading app title
# sub_app_title = 'Portfolio secure 12 Perfected.Even.Further ++ (210-F3.6)'

# database folder
app_db_folder_name = 'PS-12PEF++210F363-1Rev'
...
main_app_folder_name = 'Portfolio Secure 12 P.E.F ++ (210-F3.6.3-1Revised)'
...
class appUI(wx.Frame):
    ...
    def open_collection_folder_dt3(self, event):
        ...
        if json_path_datas_exists == True:
            ...
            fg_open_lists = ["Choose here to access '{}' folder.".format(collections_folder_name),
                             "Choose here to access '{}' folder.".format(encfiles_subfolder2_name),
                             "Choose here to access '{}' folder.".format(encfolders_subfolder2_name),
                             "Choose here to access '{}' folder.".format(decfiles_subfolder2_name),
                             "Choose here to access '{}' in folder.".format(decfolders_subfolder2_name)]
...
class FolderGuardian(wx.Dialog):
    ...
    def __init__(self, parent, id):
        ...
        self.name1_lbl = wx.StaticText(self.wpanel, -1, "Portfolio Secure 12 P.E.F ++ \n(210-F3.6.3-1Rev) - \nFolder Guardian", (67, 85), (24, 24),
