...
app_name = "PS 12 PEF++ (210F3.6.3-2D)"
...
''' Main App detials '''
# App details
app_title = "Portfolio Secure 12 Perfected.Even.Further ++ (210-F3.6.3-2D)"

# GUI messages heading app title
# sub_app_title = 'Portfolio Secure 12 Perfected.Even.Further ++ (210-F3.6)'

# database folder
app_db_folder_name = 'PS-12PEF++210F363-2D'
...
main_app_folder_name = 'Portfolio Secure 12 P.E.F ++ (210F3.6.3-2D)'
...
class FolderGuardian(wx.Dialog):
    ...
    def __init__(self, parent, id):
        ...
        self.name1_lbl = wx.StaticText(self.wpanel, -1, "Portfolio Secure 12 P.E.F ++ (210-F3.6.3-2D) \nFolder Guardian",
                                       (67, 85), (24, 24),
