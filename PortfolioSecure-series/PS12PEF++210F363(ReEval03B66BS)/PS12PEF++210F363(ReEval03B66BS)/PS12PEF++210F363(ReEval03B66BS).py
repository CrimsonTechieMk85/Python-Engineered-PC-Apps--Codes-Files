...
''' Main App detials '''
# App details
app_title = "Portfolio secure 12 Perfected.Even.Further ++ (210-F3.6.3)"

# GUI messages heading app title
# sub_app_title = 'Portfolio secure 12 Perfected.Even.Further ++ (210-F3.6)'

# database folder
app_db_folder_name = 'PS-12PEF++210F363'
...
main_app_folder_name = 'Portfolio secure 12 P.E.F ++ (210-F3.6.3)'
...
class appUI(wx.Frame):
    ...
    def open_collection_folder_dt2(self, event):
        ...
        if settings_json_fl_exists == False:
            ...
            fg_open_lists = ["Choose here to access '{0}' in '{1}' folder.".format(encfiles_subfolder2_name,collections_folder_name), 
                            "Choose here to access '{0}' in '{1}' folder.".format(encfolders_subfolder2_name,collections_folder_name), 
                            "Choose here to access '{0}' in '{1}' folder.".format(decfiles_subfolder2_name,collections_folder_name), 
                            "Choose here to access '{0}' in '{1}' folder.".format(decfolders_subfolder2_name,collections_folder_name)]
    ...
    def open_ps_encfiles(self):
        ...
        # Main app folders ->
            ...
            os.startfile(self.subfolder2_encfiles_pathr̥)
        except FileNotFoundError:
            pass
