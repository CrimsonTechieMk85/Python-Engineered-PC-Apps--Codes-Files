...
app_name = "PS 12 PEF++ (210 B2.2-type)"
...
''' Main App detials '''
# App details
app_title = "Portfolio secure 12 Perfected.Even.Further ++ (210-B2.2)"

# GUI messages heading app title
sub_app_title = 'PS 12 P.E.F++ 210 B2.2'

# database folder
app_db_folder_name = 'PS-12PEF++210B2.2'
...
main_app_folder_name = 'Portfolio secure 12 P.E.F ++ (210-B2.2)'
...
class FolderGuardian(wx.Frame):
    ...
    def __init__(self, parent, id):
        ...
        self.name1_lbl = wx.StaticText(self.wpanel, -1, "Portfolio secure 12 P.E.F ++ (210-B2.2) - \nFolder Guardian", (67, 85), (24, 24),
...
class FileGuardian(wx.Frame):
    ...
    def modify2(self, event):
        ...
        onechoice = wx.SingleChoiceDialog(self.wpanel, "Which settings do you wish to change?",
                                          '{} - modify settings'.format(app_name), fg_modify_lists,style=wx.OK | wx.CANCEL | wx.CENTRE, pos=wx.DefaultPosition)
        ...
        try:
            ...
            while True:
                ...
                filedir_dlgbox = wx.FileDialog(self.wpanel, "Please choose the required file to be encrypted:", "", "",
                                               wildcard="All files (*.*)|*.*; | JPEG (*.jpeg) |*.Jpeg; | PNG (*.png) |*.png; | MP4 (*.mp4) |*.mp4; | WEBM (*.webm) |*.webm; | M4A (*.m4a)|*.m4a; | M4V (*.m4v) | *.m4v;",
                                               style=wx.FD_OPEN | wx.FD_FILE_MUST_EXIST)
