...
class Ui_MainWindow(QWidget):
    ...
    # Option
        ...
        self.actionOpen_Logsfolder.setText((_translate("MainWindow", f"Open '{log_dirname}' folder")))
    ...
    def user_only_access_ps_decfolders(self,path5_2):
        while True:
            ...
            if folder_guardian_dec_passwr5_2_out==True and folder_guardian_dec_passwr5_2_txt != '':
